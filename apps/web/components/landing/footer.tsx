      ...
      <div className="mx-auto max-w-5xl px-6 py-16 lg:px-8">
        ...
        <div className="flex flex-col gap-10 sm:flex-row sm:justify-between">
          ...
          <div className="max-w-[260px]">
            ...
            <p className="text-[1rem] font-medium leading-[1.65] tracking-[-0.005em] text-white/38">
              Continuous GDPR &amp; EU AI Act compliance for companies building
              in Europe.
            </p>
          </div>
        ...
        >
          <p className="text-[14px] font-medium tracking-[-0.005em] text-white/22">
            &copy; {new Date().getFullYear()} Entear O&Uuml;. Free software
            under{' '}
            <a
              href={GITHUB_LICENSE_URL}
              target="_blank"
          ...
          <p className="text-[13px] font-medium text-white/18 max-w-xs leading-[1.6]">
            AI-generated compliance guidance for planning purposes only. Not
            legal advice.
          </p>
        </div>
      </div>
